  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        subtitle="Track user efficiency and transaction activity"
      >
        <button
      ...
      {isLoading && (
        <Card>
          <LoadingState message="Loading user activity data..." />
        </Card>
      )}
      ...
      {data && !isLoading && (
        <>
          ...
          {data.daily_activity.length > 0 && (
            <Card title="Daily Activity" icon={Calendar}>
          ...
          {/* User Table */}
          <Card title="User Breakdown" icon={Users} padding={false}>
            ...
            {data.users.length === 0 && (
              <EmptyState
                icon={Users}
                title="No user activity found"
                message="No user activity found for the selected period"
              />
            )}
          </Card>
          ...
          {Object.keys(data.summary.by_type).length > 0 && (
            <Card title="Transaction Types Summary" icon={FileText}>
              <div className="grid grid-cols-4 gap-4">
