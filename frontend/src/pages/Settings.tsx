...
import { Save, RefreshCw, CheckCircle, AlertCircle, ExternalLink, Mail, Trash2, TestTube, Database, Server, CreditCard, Pencil, X, Settings as SettingsIcon } from 'lucide-react';
...
export function Settings() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Recurring Entries Configuration */}
