    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Sales Ledger vs Nominal Ledger control account</p>
        </div>
        <button
              ...
              <div className="p-4 border-t">
                <div className="grid grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm text-gray-600">Sales Ledger Balance</p>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">SL Balance</th>
