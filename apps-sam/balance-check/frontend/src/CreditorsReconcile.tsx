...
import type { ReconciliationResponse } from './api-shim';
import { PageHeader, Card, LoadingState, Alert, SectionHeader } from './ui-shim';
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        subtitle="Purchase Ledger vs Nominal Ledger control account"
      >
        <button
        ...
        <div className="grid grid-cols-3 gap-4">
          <Card>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{formatCurrency(purchaseLedgerTotal)}</div>
              <div className="text-sm text-gray-500 mt-1">Purchase Ledger</div>
            </div>
          </Card>
          <Card>
            <div className="text-center">
        ...
        <div className="space-y-4">
              ...
              <div className="p-6 border-t border-gray-100">
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="text-center p-6 bg-emerald-50 rounded-xl border border-emerald-100">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Purchase Ledger (ptran)</p>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <SectionHeader
              ...
              expanded={expandedSections.has('purchase_ledger')}
              onToggle={() => toggleSection('purchase_ledger')}
            />
                ...
                {data.purchase_ledger?.supplier_master_check && (
                  <div className="mt-4 p-4 bg-gray-50 rounded-xl">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-gray-700">Supplier Master (pname) Check</p>
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {data.top_suppliers.map((supplier, idx) => (
                          <tr key={idx} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="py-3 px-4 text-sm text-gray-700">{supplier.name}</td>
                            <td className="py-3 px-4 text-right text-sm font-semibold text-gray-900">
