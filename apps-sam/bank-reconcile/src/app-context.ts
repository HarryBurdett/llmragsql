 ...
 * balance-check and gocardless. See balance-check/src/app-context.ts
 * for the rationale (defining locally avoids tight coupling to SAM's
 * package layout).
 */
...
export interface AppContext {
  ...
  db: {
    sam: Knex;
    app: Knex | null; // bank_aliases + bank_patterns + statement history
